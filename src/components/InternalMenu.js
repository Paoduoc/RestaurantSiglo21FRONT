      ...
      <div className='body'>
        <div className='flex centered mt-30'>
          ...
          <h1 className='Title'>Menú interno</h1>
            ...
            <br></br>
            <button type="button" className='btn btn-danger' onClick={() => goTo('/commands')}>Cocina</button>
            <br></br>
            ...
            <br></br>
            <button type="button" className='btn btn-danger' onClick={() => goTo('/Reporteria')}>Reporteria</button>
            <br></br>
            <br></br>
            <br></br>
            <br></br>
