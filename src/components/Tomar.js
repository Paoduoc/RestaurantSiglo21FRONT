...
const Tomar = (props) => {
  ...
  <table className="tg">
    ...
    <tbody>
      <tr>
        <td className="tg-sjuo">Mesa 23</td>
        <td className="tg-sjuo">$10000</td>
        <td className="tg-sjuo">10 minutos</td>
        <td className="tg-sjuo">JPonce</td>
        <td className="tg-0l6a">Tiramisu(1) y Pastel de Choclo(1)</td>
        <td className="tg-0l6a">2</td>
        
        <td className="tg-sjuo"><Botonnormal
      ...
      <tr>
        <td className="tg-0lax">Mesa 24</td>
        <td className="tg-0lax">$12000</td>
        <td className="tg-0lax">13 minutos</td>
        <td className="tg-0lax">JVelez</td>
        <td className="tg-baqh">Coca Cola (1) Tiramisu(1) Pastel de Choclo (1)</td>
        <td className="tg-baqh">3</td>
        
        <td className="tg-0lax" > <Botonnormal
                  rootClassName="botonnormal-root-class-name"
                  nombrecito="Tomar Pedido"
                  className="home-component2"
                ></Botonnormal></td>
      ...
      <tr>
        <td className="tg-sjuo">Mesa 25</td>
        <td className="tg-sjuo">$5000</td>
        <td className="tg-sjuo">10 minutos</td>
        <td className="tg-sjuo">JAraneda</td>
        <td className="tg-0l6a">Charquican(1)</td>
      ...
      <tr>
        <td className="tg-0lax">Mesa 29</td>
        <td className="tg-0lax">$7000</td>
        <td className="tg-0lax">6 minutos</td>
        <td className="tg-0lax">JLopez</td>
        <td className="tg-baqh">Pastel de Choclo (1) Coca Cola(1)</td>
      ...
      <tr>
        <td className="tg-sjuo">Mesa 27</td>
        <td className="tg-sjuo">$20000</td>
        <td className="tg-sjuo">15 minutos</td>
        <td className="tg-sjuo">JPonce</td>
        <td className="tg-0l6a">Pastel de Choclo (4)</td>
        <td className="tg-0l6a"> 4</td>
        <td className="tg-sjuo"> <Botonnormal
                  rootClassName="botonnormal-root-class-name"
                  nombrecito="Tomar Pedido"
                  className="home-component2"
  ...
  <table className="tg">
    <thead>
      <tr>
        ...
        <th className="tg-nrix">Productos </th>
        <th className="tg-nrix">Cantidad</th>
        <th className="tg-0lax">Acción</th>
      </tr>
    </thead>
    <tbody>
      <tr>
      ...
      <tr>
        <td className="tg-sjuo"></td>
        <td className="tg-sjuo"></td>
        <td className="tg-sjuo"></td>
        <td className="tg-sjuo"></td>
        <td className="tg-0l6a"></td>
        <td className="tg-0l6a"></td>
